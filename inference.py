...
if __name__ == "__main__":
    ...
    while True:
        ...
        if answers is None:
            ...
            index = max(answers['scores'])
            print(answers['answers'][index])
            #for i, _ in enumerate(answers['scores']):
            #print((answers['answers'][0]))
                #print("{}- {}{}".format(colorama.Fore.WHITE if answers['scores'][i] == 1 else colorama.Fore.WHITE if answers['scores'][i] == 0 else colorama.Fore.WHITE, answers['answers'][i], colorama.Fore.RESET))
